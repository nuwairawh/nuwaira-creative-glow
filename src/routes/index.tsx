        ...
        >
          ...
          <div className="relative space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 border-t border-[var(--glass-border)] pt-5">
              <a href="mailto:nuwairaahmed4@gmail.com" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
                <Mail className="h-4 w-4" /> nuwairaahmed4@gmail.com
              </a>
